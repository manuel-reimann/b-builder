...
const data: Data = {
  ...
  Sprayroses: [
    { label: "Fire Up", src: "/img/sprayroses/fireup.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Bellinda Brick", src: "/img/sprayroses/bellinda-brick.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Bellalinda Monet", src: "/img/sprayroses/bellalinda_monet.webp", type: "sprayrose", maxHeight: 200 },
    { label: "La Manderina", src: "/img/sprayroses/la-mandarina.webp", type: "sprayrose" },
    { label: "Bright Sensation", src: "/img/sprayroses/bright_sensation.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Julieta", src: "/img/sprayroses/julieta.webp", type: "sprayrose", maxHeight: 200 },
    { label: "B.S. Leo", src: "/img/sprayroses/b.s._leo.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Royal Rosever", src: "/img/sprayroses/royal_rosever.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Happy Birthday", src: "/img/sprayroses/happy-birthday.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Ritual", src: "/img/sprayroses/ritual.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Elegant Rosever", src: "/img/sprayroses/elegant_rosever.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Ilse", src: "/img/sprayroses/Ilse.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Be Amazing", src: "/img/sprayroses/be_amazing.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Sweet Dreams", src: "/img/sprayroses/sweet_dreams.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Silver Shadow", src: "/img/sprayroses/silver_shadow.webp", type: "sprayrose", maxHeight: 200 },
    { label: "Verona", src: "/img/sprayroses/verona.webp", type: "sprayrose", maxHeight: 200 },
  ],
  ...
  Lilien: [
    { label: "Dunkelviolett", src: "/img/lilien/dunkelviolett.webp", type: "lilien", maxHeight: 300 },
    { label: "Weiss", src: "/img/lilien/weiss.webp", type: "lilien", maxHeight: 300 },
    { label: "Weisspink", src: "/img/lilien/weisspink.webp", type: "lilien", maxHeight: 300 },
    { label: "Pink", src: "/img/filler/lillie.webp", type: "filler", promptAddition: "Keep the lilies’ petals and stamens intact; adjust only minor petal positioning for realism.", stackable: true, maxHeight: 300 },
  ],
  Hortensien: [
    { label: "Dunkelviolett", src: "/img/hortensien/hotpink.webp", type: "hortensien", maxHeight: 300 },
    { label: "Pink", src: "/img/hortensien/pink.webp", type: "hortensien", maxHeight: 300 },
    { label: "Pink-Grün", src: "/img/hortensien/pinkgruen.webp", type: "hortensien", maxHeight: 300 },
    { label: "Fake-Rot", src: "/img/hortensien/rot_fake.webp", type: "hortensien", maxHeight: 300 },
    { label: "Violett", src: "/img/hortensien/violett.webp", type: "hortensien", maxHeight: 300 },
  ...
  Spraynelken: [
    ...
    { label: "Orange-Gelb", src: "/img/spraynelken/spraynelke_orange_gelb.webp", type: "spraynelken", maxHeight: 175 },
    { label: "Violett", src: "/img/spraynelken/spraynelke_violett.webp", type: "spraynelken", maxHeight: 175 },
    { label: "Weiss", src: "/img/spraynelken/spraynelke_weiss.webp", type: "spraynelken", maxHeight: 175 },
  ],
  Nelken: [
    {
      label: "Nelke Hotpink",
  ...
  Filler: [
    ...
    { label: "Eryginum", src: "/img/filler/eryginum.webp", type: "filler", stackable: false, maxHeight: 200 },
    { label: "Stadizie", src: "/img/filler/stadizie.webp", type: "filler", stackable: false, maxHeight: 250 },
    { label: "Kangurupfote", src: "/img/filler/kaengurupfote.webp", type: "filler", stackable: false, maxHeight: 300 },
  ],
};
