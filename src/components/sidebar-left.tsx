...
const data: Data = {
  ...
  Roses: [
    {
      ...
      type: "flower",
      promptAddition: "Add a small amount of rose foliage confined to the interior of the bouquet: short stem segments and small serrated rose leaflets partially occluded by petals in the gaps between adjacent heads. Do not add any background greenery or scenery; do not place leaves outside or behind the sleeve.",
      stackable: false,
    },
    {
      label: "Lady in Red",
  ...
  "Sri Lanka": [
    { label: "Monstera Epipremnum", src: "/img/srilanka/monstera_ epipremnum.webp", type: "srilanka", promptAddition: "Preserve the existing heart-shaped vine leaves exactly as they are; do not recolor or replace any foliage.", stackable: true },
    { label: "Dracaena Sanderiana White", src: "/img/srilanka/dracaena_sanderiana_white.webp", type: "srilanka", promptAddition: "Preserve the green leaves with white stripes exactly; do not recolor or replace them.", stackable: true },
    { label: "Dracaena surculosa Florida Beauty", src: "/img/srilanka/ds_florida_beauty.webp", type: "srilanka", promptAddition: "Preserve the yellow-speckled variegation on dark green leaves; do not recolor or simplify them.", stackable: true },
    { label: "Chrysalidocarpus lutescens", src: "/img/srilanka/kentia.webp", type: "srilanka", promptAddition: "Preserve the palm-like fronds with narrow leaflets exactly; do not recolor or replace them.", stackable: true },
    { label: "Polyscias scutellaria", src: "/img/srilanka/polyscias_scutellaria.webp", type: "srilanka", promptAddition: "Preserve the rounded shield-like leaflets exactly; do not recolor or simplify them.", stackable: true },
    { label: "Cordyline fruticosa Indian Summer", src: "/img/srilanka/cordyline_fruticosa_indian_summer.webp", type: "srilanka", promptAddition: "Preserve the strap-like cordyline leaves with mixed warm tones and glossy texture; do not recolor or reshape them.", stackable: true },
    { label: "Cordyline fruticosa Red", src: "/img/srilanka/cordyline_fruticosa_red.webp", type: "srilanka", promptAddition: "Preserve the deep burgundy strap leaves exactly; do not recolor or replace them.", stackable: true },
    { label: "Cordyline fruticosa Yellow Flash", src: "/img/srilanka/cordyline_fruticosa_yellow_flash.webp", type: "srilanka", promptAddition: "Preserve the yellow-green variegated strap leaves exactly; do not simplify or recolor them.", stackable: true },
    { label: "Cordyline Fruticosa", src: "/img/srilanka/cordyline_fruticosa.webp", type: "srilanka", promptAddition: "Preserve the long, glossy cordyline leaves exactly; do not recolor or replace them.", stackable: true },
    { label: "Cordyline Fruticosa Red Majesty", src: "/img/srilanka/cordyline_fruticosa_red_majesty.webp", type: "srilanka", promptAddition: "Preserve the rich burgundy leaves with lighter margins exactly; do not recolor or replace them.", stackable: true },
  ],
  "Flower Plugs": [
